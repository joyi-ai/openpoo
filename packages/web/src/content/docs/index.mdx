...
- **Using Node.js**
      ...
      <TabItem label="npm">
      ```bash
      npm install -g @joyi-ai/openagent
      ```
        ...
        <TabItem label="Bun">
        ```bash
        bun install -g @joyi-ai/openagent
        ```
        ...
        <TabItem label="pnpm">
        ```bash
        pnpm install -g @joyi-ai/openagent
        ```
        ...
        <TabItem label="Yarn">
        ```bash
        yarn global add @joyi-ai/openagent
        ```
...
- **Using Mise**
  ...
  ```bash
  mise use -g github:joyi-ai/openagent
  ```

- **Using Docker**

  ```bash
  docker run -it --rm ghcr.io/joyi-ai/openagent
  ```

Support for installing OpenCode on Windows using Bun is currently in progress.

You can also grab the binary from the [Releases](https://github.com/joyi-ai/openagent/releases).
